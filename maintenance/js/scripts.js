...
(function ($) {
	...
	*/
    ...
    $("#contact-form").on('submit', function(e) {
        ...
        var dataString = 'name=' + name + '&email=' + email + '&message=' + message+ '&siteStatus=maintenance';
        ...
        if (isValidEmail(email) && (message.length > 1) && (name.length > 1)) {
          $.ajax({
            type: "POST",
            url: "https://script.google.com/macros/s/AKfycbwy58FFj7vV9pILbHpLXfInbP1QA2znqIqnc0bGjVazJ8JzK_o/exec",
            data: dataString,
            success: function() {
  ...
  $("#subscribe-form").on('submit', function(e) {
    ...
    var dataString='email='+email+ '&siteStatus=maintenance';
    ...
    if (isValidEmail(email)) {
      ...
      $('#subscribe-form .error').fadeOut(500);
      $.ajax({
        type: "POST",
        url: "https://script.google.com/a/colorsailing.com/macros/s/AKfycbzXYVUMdaqmosXfGum8afrFfOdwUs4qZJGXonXu/exec",
        data: dataString,
        success: function() {
              $('#subscribe-form .success').fadeIn(1000);
              $('#subscribe-form .error').fadeOut(500);
